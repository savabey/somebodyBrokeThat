...
char organization[] = "zh4ruo";
char typeId[] = "cc3200";
char pubtopic[] = "iot-2/evt/status/fmt/json";
char subTopic[] = "iot-2/cmd/+/fmt/json";
char deviceId[] = "544a162a8e07";
char clientId[64];
...
char authToken[] = "WoDe_!mmh_t_WA67F_";
...
void loop() {
  ...
  dtostrf(4095-analogRead(2),1,2, &json[43]);
  json[46] = '\t';
 
  dtostrf(analogRead(A3),1,2, &json[47]);
  json[52] = '}';
  json[53] = '}';
  json[54] = '\0';
